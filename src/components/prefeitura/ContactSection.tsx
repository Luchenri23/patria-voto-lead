      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Sua opinião é importante! Entre em contato conosco para sugestões, 
            reclamações ou para agendar uma audiência.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
                ...
                <div className="space-y-2">
                  ...
                  <Select required>
                    ...
                    <SelectContent className="bg-background border border-border z-50">
                      ...
                      <SelectItem value="audiencia">Solicitar Audiência</SelectItem>
            ...
            <motion.div
              ...
              className="mt-6 bg-primary rounded-xl p-6"
            >
              <h3 className="text-lg font-bold text-primary-foreground mb-2">
                Receba Novidades
              </h3>
              <p className="text-primary-foreground/80 text-sm mb-4">
                Cadastre-se para receber as últimas notícias da gestão diretamente no seu e-mail.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Prefeitura Municipal de Canoinhas<br />
                      Rua Felipe Schmidt, 10 - Centro<br />
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      gabinete@canoinhas.sc.gov.br<br />
                      contato@julianamaciel.com.br
                    </p>
                  </div>
                </div>
